...
{
    public class VendasCidadePageViewModel : ViewModelBase
    {
        ...
        public VendasCidadePageViewModel(INavigationService navigationService, IPageDialogService _dialogService, IDataService _dataservice)
        ...
        private async Task VendasMesAsync()
        {
            try
            {
                if (Connectivity.NetworkAccess == NetworkAccess.Internet)
                    ...
                    {
                        //Faturamento por Mês
                        var lista = await dataService.GetVendasCidadeAsync(DtFiltro.Month, DtFiltro.Year);
