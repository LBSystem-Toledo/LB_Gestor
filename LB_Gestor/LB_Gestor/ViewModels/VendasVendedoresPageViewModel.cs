...
{
    public class VendasVendedoresPageViewModel : ViewModelBase
    {
        ...
        public VendasVendedoresPageViewModel(INavigationService navigationService, IPageDialogService _dialogService, IDataService _dataservice)
        ...
        private async Task VendasMesAsync()
        {
            try
            {
                if (Connectivity.NetworkAccess == NetworkAccess.Internet)
                    ...
                    {
                        //Faturamento por Mês
                        var lista = await dataService.GetVendasVendedoresAsync(DtFiltro.Month, DtFiltro.Year);
